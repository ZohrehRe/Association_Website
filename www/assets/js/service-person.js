...
//        te.innerHTML="Here you can find all events that are related to " + name;
    ...
    for(var i=0; i<json.length; i++){
        ...
        listItem.innerHTML='<div class="card mb-3" ><div class="row no-gutters"><div class="col-md-2"><img src="'+photo+'" class="card-img" alt="..."></div><div class="col-md-10"><div id="'+id+'" class="card-body"><a href="person.html?id='+id+'"><h5 class="card-title">'+name+" "+lastname+'</h5></a><p class="card-text">'+summary+'</p></div></div></div></div>';
